                ...
                <table class="table table-hover display" id="_table">
                    ...
                    @foreach($topics as $topic)
                        <tr>
                            ...
                            <td><a class="text-decoration-none text-dark" href="{{route('topics.details', $topic['id'])}}">{{$topic['topicTitle']}}</a>
                            </td>
                            ...
                            <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('topics.edit', $topic['id'])}}"><img src="{{asset('admin/assets/images/edit-svgrepo-com.svg')}}"></a></td>
                            <td class="text-center"><a class="text-decoration-none text-dark">
                                <form action="{{route('topics.destroy', $topic->id)}}" method="POST" method="POST" onclick="return confirm('Are you sure you want to delete?')">
                                @csrf
                                @method('delete')
