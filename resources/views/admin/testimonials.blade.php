                ...
                <table class="table table-hover display" id="_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('testimonials.edit', $testimonial['id'])}}"><img src="{{asset('admin/assets/images/edit-svgrepo-com.svg')}}"></a></td>
                            <td class="text-center"><a class="text-decoration-none text-dark">
                                <form action="{{route('testimonials.destroy', $testimonial->id)}}" method="POST" method="POST" onclick="return confirm('Are you sure you want to delete?')">
                                @csrf
                                @method('delete')
